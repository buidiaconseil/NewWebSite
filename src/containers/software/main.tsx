...
<hr></hr>
  <div class="row">
    ...
    <a href="#/software/development" type="button" class="btn btn-secondary">Development</a>
    <a href="#/software/management" type="button" class="btn btn-secondary">Management</a>
    ...
    <div class="col-2"><a class="twitter-timeline" data-width="220" data-theme="dark" href="https://twitter.com/RedHat?ref_src=twsrc%5Etfw">Tweets by RedHat</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></div>
  </div>
</div>
