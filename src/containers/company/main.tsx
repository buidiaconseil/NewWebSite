        ...
        <div class="row">
          <div class="col-2">
            <div class="btn-group-vertical btn-group-sm">
              ...
              <a href="#/company/team" type="button" class="btn btn-secondary">
                Team
              </a>
              <a
              ...
              <a href="#/company/legal" type="button" class="btn btn-secondary">
                Legal
              </a>
              <a href="#/company/terms" type="button" class="btn btn-secondary">
                Terms
              </a>
              <a
