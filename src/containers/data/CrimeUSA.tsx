...
export default class Hello extends React.Component<HelloProps, {}> {
  render() {
    return (
      <div>
        <h2>Images of violent crimes by state in USA</h2>
        <p className="lead text-left">
          The first image propose the max county value of the state The second
          image is the mean value of the violent crime of the counties
          <p>
