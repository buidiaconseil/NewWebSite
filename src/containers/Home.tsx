    ...
    <div className="carousel-item active">
      ...
      <div className="container">
                <div className="carousel-caption text-left">
                  ...
                  <p><a className="btn btn-lg btn-primary" href="/#/data" role="button">Learn more</a></p>
                </div>
              </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="container">
                <div className="carousel-caption text-right">
                  ...
                  <p><a className="btn btn-lg btn-primary" href="/#/data/sport" role="button">Learn more</a></p>
                </div>
              </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="container">
                <div className="carousel-caption">
                  ...
                  <p><a className="btn btn-lg btn-primary" href="/#/software" role="button">Learn more</a></p>
                </div>
              </div>
    </div>
    <div className="carousel-item">
